...
class GerenciadorTarefas:
    ...
    # Criando a label
    def criarLabel(self):
        self.labelPrincipal = Label(self.janela, text='LISTA DE TAREFAS PENDENTES', fg='#363636', 
                                                font=('Arial, bold', 14), bg='white')
        self.labelPrincipal.place(relx=0.04, rely=0.02, width=640, height=45)

    # Criando botões
    def criarBotões(self):
        self.btnExcluir = Button(self.janela, text='excluir', font=('Arial bold', 12), bg='white')
        self.btnExcluir.place(relx=0.04, rely=0.16, relwidth=0.15, relheight=0.08)

        self.btnPesquisar = Button(self.janela, text='pesquisar', font=('Arial bold', 12), bg='white')
        ...
        self.btnAtualizar = Button(self.janela, text='atualizar tarefas', font=('Arial bold', 12), 
                                    bg='white', command=lambda:self.criarTabelaTarefas())
    ...
    def criarTabelaTarefas(self):
        ...
        self.tabela.bind('<Double-1>', self.atualizar)
    ...
    def atualizar(self, event):
        ...
        for i in self.tabela.selection():
            col1, col2, col3, col4, col5 = self.tabela.item(i, 'values')
            Atualizar.inserir(self, col1, col2, col3, col4, col5)
